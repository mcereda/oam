...
# Compare the current configuration with the defaults
...
<details>
  <summary>Through the web UI</summary>
...
<details>
  <summary>Through API calls</summary>
...
<details>
  <summary>Through <code>gitlab-ctl</code></summary>
...
<details>
  <summary>Through Rails console</summary>
...
The Python SDK also provides a CLI tool to operate with the API.<br/>
See also [python-gitlab].
...
```sh
# Check for any pending ('down') migrations
sudo gitlab-rake db:migrate:status | grep "down"

# Run all pending migrations
sudo gitlab-rake db:migrate

# Re-run the chef configuration setup
sudo gitlab-ctl reconfigure
```
...
[Kaniko]: kaniko.md
[MinIO]: minio.md
[python-gitlab]: gitlab/python-gitlab.md
