...
AI can help automate repetitive cognitive work. This _would_ free people from menial tasks, and allow them to focus on
higher-value, more meaningful work, if only people didn't use this time to work more.<br/>
It also extends capability in domains that were previously inaccessible or unaffordable, like real-time translation,
live transcription, navigation aids for the visually impaired, and assistive communication tools for people with
disabilities.

AI-assisted research has dramatically shortened timelines in many fields like drug discovery, materials science, climate
modeling, and medicine.<br/>
DeepMind's AlphaFold was able to effectively predict the structure of virtually all known proteins.
...
fall prey to convenience.

### Mental and emotional manipulation

Some AI systems, especially those that deal with humans, are _designed_ to simulate emotional or social interaction,
mimicking empathy while lacking _real_ understanding or awareness and presenting themselves as useful parties.<br/>
...
AIs proved proficient in manipulating people in real-time, often to achieve _targeted influence objectives_.<br/>
Companies are loosely regulated if at all. They could steer and bias their products to subtly promote ideologies and
influence masses.

### Difficulty of understanding

AIs can be far faster than humans in many tasks, and far more efficient in outputting results.<br/>
Current models are often better characterised as sophisticated pattern matching machines (_T9 on steroids_) than
systems capable of classical reasoning, though modern LLMs do show reasoning capabilities through chain-of-thought and
multi-step problem solving.

Researchers are starting to struggle keeping up with AIs and their inner workings. They are already a black box in many
cases, and they are still evolving.
