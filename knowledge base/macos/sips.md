...
Command-line tool shipped by default with macOS which allows basic image manipulation.<br/>
...
Its functionality can be used through the "Image Events" AppleScript suite, and supports executing JavaScript to either
